...
const username=promiseFour.then((user)=>{  //you cannot store the result in a variable we can resolve it by only implimenting again then it is known as chaining
    console.log(user);
